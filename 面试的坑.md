...
深入理解JavaScript https://segmentfault.com/a/1190000018513150
...
![](G:\Work\preparation-for-job-hunting\img\react旧版生命周期.png)

react新版生命周期

![](G:\Work\preparation-for-job-hunting\img\react新版生命周期.png)
...
loader是一个记载器，最重要的是使webpack拥有加载和解析非js文件的能力。例如，将A文件编译成B文件，例如将A.scss编译成A.css
...
![](G:\Work\preparation-for-job-hunting\img\浏览器可视区域.jpg)
